#!/usr/bin/env python
"""Shared HTTP serving implementation for alignment CrossEncoders."""
...
def add_server_arguments(parser: argparse.ArgumentParser, *, default_model: str, default_port: int) -> None:
    parser.add_argument(
        "--model-path",
        default=default_model,
        help="Local CrossEncoder directory or Hugging Face model identifier.",
    )
...
def run_server(
    ...
    *,
    ...
    parser = argparse.ArgumentParser(
        description=f"Serve the {role} alignment CrossEncoder."
    )
    add_server_arguments(parser, default_model=default_model, default_port=default_port)
    ...
    print(f"Serving {role} aligner on http://{args.host}:{args.port}", flush=True)
