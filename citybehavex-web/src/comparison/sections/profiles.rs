...
//! `web/backend/app/payload/legacy.py`'s profiles section.

use crate::payload::{ComparisonContext, available_filters, empty_chart_payload, prepared_visits_for_filter};
use polars::prelude::*;
