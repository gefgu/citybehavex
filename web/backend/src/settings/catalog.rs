...
//! id -> name/description table `legacy Python backend/timeline.py` builds once at
...
pub const CATALOG: &[ActivityDef] = &[
    ...
    activity!(
        1,
        "eatdrink",
        "Eating, drinking, coffee, lunch, and meal breaks",
        -0.35,
        0.45,
        [0, 1, 2]
    ),
    activity!(
        2,
        "selfcare",
        "Personal hygiene, grooming, and private care",
        -0.69,
        0.50,
        [0, 2]
    ),
    activity!(
        3,
        "paidwork",
        "Working at the office or job site",
        2.08,
        0.30,
        [1]
    ),
    activity!(
        4,
        "educatn",
        "Studying, attending class, or doing homework",
        1.10,
        0.50,
        [2]
    ),
    ...
    activity!(
        7,
        "maintain",
        "Household maintenance, repairs, and administrative upkeep",
        0.00,
        0.60,
        [0]
    ),
    ...
    activity!(
        9,
        "garden",
        "Gardening and outdoor household work",
        0.41,
        0.60,
        [0]
    ),
    ...
    activity!(
        11,
        "eldcare",
        "Caring for adults or older household members",
        0.41,
        0.70,
        [0, 2]
    ),
    activity!(
        12,
        "pkidcare",
        "Physical childcare and supervision",
        0.41,
        0.70,
        [0, 2]
    ),
    activity!(
        13,
        "ikidcare",
        "Interactive childcare, play, and homework help",
        0.41,
        0.70,
        [0, 2]
    ),
    activity!(
        14,
        "religion",
        "Religious practice, ceremonies, and worship",
        0.69,
        0.60,
        [2]
    ),
    activity!(
        15,
        "volorgwk",
        "Volunteering, civic, and organizational work",
        0.69,
        0.60,
        [2]
    ),
    activity!(
        16,
        "commute",
        "Commuting to and from work or education",
        -0.29,
        0.50,
        [1, 2]
    ),
    activity!(
        17,
        "travel",
        "Travel for personal, household, and leisure activities",
        -0.29,
        0.50,
        [2]
    ),
    activity!(
        18,
        "sportex",
        "Sports, exercise, and gym sessions",
        0.41,
        0.40,
        [2]
    ),
    activity!(
        19,
        "tvradio",
        "Watching TV, listening to radio, and passive media",
        0.92,
        0.60,
        [0, 2]
    ),
    ...
    activity!(
        21,
        "compint",
        "Computer, internet, gaming, and online leisure",
        0.41,
        0.50,
        [0, 2]
    ),
    activity!(
        22,
        "goout",
        "Going out to restaurants, cinema, theatre, or events",
        0.92,
        0.50,
        [2]
    ),
    activity!(
        23,
        "leisure",
        "Social, recreational, and other leisure activities",
        0.92,
        0.60,
        [0, 2]
    ),
    activity!(
        24,
        "missing",
        "Unclassified or missing diary time; shown in comparisons only",
        0.00,
        0.50,
        []
    ),
