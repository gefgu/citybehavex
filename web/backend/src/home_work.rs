...
//!
//! Mirrors `legacy Python backend/home_work_data.py`, but uses Rust `h3o` for H3
...
// `legacy Python backend/home_work_data.py::AGE_BRACKETS` literally, not a hyphen.
...
/// `legacy Python backend/home_work_data.py::_FINE_RESOLUTION` (12, ~10m edge
